      ...
      $window.scroll(function() {
        ...
        if ($window.scrollTop() > HeaderTop) {
          $ttStuckParentMenuCategories.append(
            $ttDesctopParentMenuCategories.find(".tt-menu-categories").detach()
          );
          $ttStuckMobileMenuCategories.append(
            $ttMobileParentMenuCategories.find(".tt-categories-toggle").detach()
          );
        } else {
          $ttDesctopParentMenuCategories.append(
            $ttStuckParentMenuCategories.find(".tt-menu-categories").detach()
          );
          $ttMobileParentMenuCategories.append(
            $ttStuckMobileMenuCategories.find(".tt-categories-toggle").detach()
          );
        }
      });
    })();
        ...
        .on("mouseenter", function() {
          ...
          if ($ul.length) {
            var $dropdownMenu = $(this)
              ...
              dropdown_Right = $dropdownMenu.get(0).getBoundingClientRect()
                .right,
              dropdown_Bottom = $dropdownMenu.get(0).getBoundingClientRect()
                .bottom,
              ulW = parseInt($ul.css("width"), 10),
              thisR = this.getBoundingClientRect().right,
              thisL = this.getBoundingClientRect().left;
        ...
        var set_event = function() {
          $slider.on("revolution.slide.onchange", function(event, data) {
            ...
            if ($video.length && autoplay === "true") {
              ...
              $slider.one("revolution.slide.onafterswap", function(
                event,
                data
              ) {
                if (video.paused) {
